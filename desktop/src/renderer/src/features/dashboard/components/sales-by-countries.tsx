...
const colors = ['#22c55e', '#ef4444', '#14b8a6', '#f97316', '#10b981', '#a855f7', '#f43f5e']
export const SalesByCountries = ({ data }: { data: SaleByCountry[] }) => {
  ...
  const cssString = useMemo(() => getSalesPieChartCss(formattedData), [formattedData])
        ...
        {formattedData.length === 0 ? (
          ...
          <>
            ...
            <ul className="mt-4 space-y-4">
              {formattedData.length === 1 && formattedData.some((data) => data.value === 0) ? (
